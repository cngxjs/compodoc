    ...
    projects: [
        {
            ...
            testIgnore: ['**/empty-states.spec.ts', '**/standalone-features.spec.ts', '**/entity-hero.spec.ts', '**/content-sections.spec.ts', '**/coverage-report.spec.ts'],
        },
        ...
        /* todomvc-ng2 fixture tests (empty states, etc.) — uses port 4001 */
        {
            ...
            testMatch: ['**/empty-states.spec.ts', '**/entity-hero.spec.ts', '**/content-sections.spec.ts', '**/coverage-report.spec.ts'],
        },
