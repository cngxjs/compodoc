...
- **New override-context names.** `referenced-by` and `bucket-landing` join the override lists (`src/migrate/override-names.ts`); the parity drift spec re-derives them from disk.
