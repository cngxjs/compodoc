export const TRANSLATION_NL_NL = {
    'accessibility-notes': 'Toegankelijkheid',
    accessors: 'Accessors',
    ...
    api: 'API',
    'application-configuration': 'Applicatieconfiguratie',
    ...
    'derived-state': 'Afgeleide status',
    ...
    inputs: 'Inputs',
    'instance-properties': 'Instantie-eigenschappen',
    ...
    'no-overview-desc':
        'Voeg een beschrijving of metadata toe aan deze entiteit om hier een overzicht te zien.',
