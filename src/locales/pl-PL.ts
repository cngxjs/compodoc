export const TRANSLATION_PL_PL = {
    'accessibility-notes': 'Dostępność',
    accessors: 'Akcesor',
    ...
    'coverage-empty-description':
        'Uruchom compodocx z udokumentowanymi elementami, aby zobaczyć pokrycie.',
    ...
    inputs: 'Inputy',
    'instance-properties': 'Właściwości instancji',
    ...
    'open-detail-page': 'Otwórz stronę szczegółów',
    optional: 'Opcjonalne',
    outputs: 'Outputy',
    overview: 'Przegląd',
    ...
    pure: 'Czysty',
    readme: 'README',
    'referenced-by': 'Referencowane przez',
