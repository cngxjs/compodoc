...
export const Overview = (props: OverviewProps): string => {
    ...
    if (props.components?.length)
        cards.push({ icon: 'ion-md-cog', count: props.components.length, singularKey: 'component', pluralKey: 'components' });
    ...
    if (props.directives?.length)
        cards.push({ icon: 'ion-md-code-working', count: props.directives.length, singularKey: 'directive', pluralKey: 'directives' });
    if (props.injectables?.length)
        cards.push({ icon: 'ion-md-arrow-round-down', count: props.injectables.length, singularKey: 'injectable', pluralKey: 'injectables' });
    ...
    return (<>
        ...
        {!props.disableGraph && !props.disableMainGraph && props.modules && (
