                ...
                const header = (
                    <header class="cdx-member-header">
                        <span class="cdx-member-name">
                            <span
                                class={`cdx-member-name-text${e.deprecated ? ' cdx-member-name--deprecated' : ''}`}
                            >
                                {e.name}
                            </span>
                            <a
                    ...
                    <>
                        {e.deprecated && (
                            <div class="cdx-member-deprecated">
                                {e.deprecationMessage || t('deprecated')}
                            </div>
                        )}
                        {e.description && (
                            ...
                            <>
                                {child.name && (
                                    <div class="cdx-member-row">
                                        ...
                                        {child.deprecated && (
                                            <span class="cdx-member-deprecated cdx-member-deprecated--inline">
