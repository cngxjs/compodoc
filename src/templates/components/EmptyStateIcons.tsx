...
export const EmptyIconBraces = () => esSvg(
...
export const EmptyIconHost = () => esSvg(
...
export const EmptyIconPalette = () => esSvg(
...
export const EmptyIconHtml = () => esSvg(
...
export const EmptyIconTree = () => esSvg(
...
export const EmptyIconFile = () => esSvg(
...
export const EmptyIconDocument = () => esSvg(
...
export const EmptyIconSearch = () => esSvg(
...
export const EmptyIconBolt = () => esSvg(
    '<path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z" stroke-dasharray="4 2"/>'
);

/** Open book with blank pages — no README */
export const EmptyIconBook = () => esSvg(
...
export const EmptyIconEnum = () => esSvg(
