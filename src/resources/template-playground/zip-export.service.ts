...
export class ZipExportService {
  ...
  private generateReadme(): string {
    return `# compodocx Custom Templates

This ZIP file contains customized templates for compodocx documentation generation.
...
2. Use the \`--templates\` flag when running compodocx to specify the path to your custom templates:

   \`\`\`bash
   compodocx -p tsconfig.json --templates ./path/to/custom/templates/
   \`\`\`
...
For more information about customizing compodocx templates, visit:
https://compodoc.app/guides/template-customization.html

Generated by compodocx Template Playground
`;
  }
