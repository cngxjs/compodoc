...
export class HighlightOnHoverDirective implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        console.log(
            'HighlightOnHoverDirective initialized on element:',
    ...
    private removeHighlight(): void {
        ...
        if (this.originalStyles.backgroundColor) {
            this.renderer.setStyle(
                this.el.nativeElement,
                'background-color',
                this.originalStyles.backgroundColor
            );
        } else {
    ...
    private restoreOriginalStyles(): void {
        ...
        if (this.originalStyles.transition) {
            this.renderer.setStyle(
                this.el.nativeElement,
                'transition',
                this.originalStyles.transition
            );
        } else {
    ...
    toggle(): boolean {
        ...
        const isCurrentlyHighlighted =
            this.el.nativeElement.style.color !== this.originalStyles.color;
